...
const newspaperStylesData = {
    "indian": [
      ...
      { "id": "hindi-tabloid", "name": "Vibrant Hindi Tabloid", "tags": "Sensational, Bold, Devanagari", "stylePrompt": "A sensational, modern Hindi tabloid newspaper style. Use huge, bold Devanagari fonts for a shocking headline. The layout is loud and energetic. The photo is a dramatic, full-color image. The paper is standard newsprint but the colors are vibrant." },
      { "id": "hindi-local", "name": "Local Hindi Daily", "tags": "Authentic, Regional, Devanagari", "stylePrompt": "An authentic local Hindi daily newspaper. The style is simple and grounded. Use standard Devanagari fonts that are highly legible. The photo is a standard color news photo, but might have slightly lower quality, typical of regional papers. The layout is functional and dense." },
    ...
    "international": [
      ...
      { "id": "sci-fi-holo-news", "name": "Sci-Fi Holo-News", "tags": "Futuristic, Digital", "stylePrompt": "A futuristic sci-fi newspaper. The style is digital, with clean lines, sans-serif fonts, and a glowing, holographic quality. The 'paper' could be a semi-transparent screen. The photo is a sharp, futuristic color image with a slight blue tint." },
